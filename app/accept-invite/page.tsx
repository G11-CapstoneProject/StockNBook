...
function DetailGrid({ details }: { details: InviteDetails }) {
    const items = [
        ...
        { label: "Role", value: "Branch Manager", icon: UserRound },
        {
            label: "Invited email",
            value: maskEmail(details.manager_email),
            icon: Mail,
        },
    ];
...
function AcceptInviteContent() {
    ...
    const verifyOtp = async () => {
        ...
        try {
            await postInviteAction("verify_manager_invite_otp", {
                invite_token: inviteToken,
                otp,
            });
            setCurrentStep(3);
        ...
        try {
            ...
            setError(
                activateError instanceof Error
                    ...
                    : "Unable to activate your manager account."
            );
        } finally {
            setSubmitting(false);
        }
                    ...
                    <div className="mt-7 grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="rounded-2xl border border-[#E3DAEC] bg-white p-5">
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3"><UserRound className="h-5 w-5 text-[#5520AE]" /><div><p className="text-xs text-[#7D7188]">Role</p><p className="font-bold text-[#281546]">Branch Manager</p></div></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-sm leading-6 text-[#6A5E75]">
                                    Enter the 6-digit code sent to {maskEmail(details.manager_email)}.
                                </p>
                            </div>
                            <button
                                type="button"
                ...
                {currentStep === 3 && (
                    <div className="mt-6">
                        <div className="rounded-2xl border border-green-200 bg-green-50 p-4 text-sm text-green-800">
                            ...
                            <p className="mt-1 pl-7">Review the name entered by the owner. You may correct it before continuing.</p>
                        </div>
                ...
                {currentStep === 4 && (
                    <div className="mt-6">
                        <div className="rounded-2xl border border-green-200 bg-green-50 p-4 text-sm text-green-800">
                            ...
                            <p className="mt-1 pl-7">Create a password to activate your manager account.</p>
                        </div>
                ...
                <div className="mt-7 flex items-center justify-between gap-3 border-t border-[#EEE8F2] pt-5">
                    ...
                    <button
                        ...
                        onClick={() => {
                            ...
                            if (currentStep === 3) void saveManagerDetails();
        ...
        <main className="relative min-h-screen overflow-hidden bg-[#F7F4FB]">
            ...
            <div className="relative z-50 flex min-h-screen items-center justify-center p-3 sm:p-6">
                <section
                    role="dialog"
                    aria-modal="true"
                    aria-label="Accept manager invitation"
