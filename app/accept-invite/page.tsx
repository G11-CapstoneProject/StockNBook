                    ...
                    <div className="mt-7 grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="rounded-2xl border border-[#E3DAEC] bg-white p-5">
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3"><UserRound className="h-5 w-5 text-[#2D1B4E]" /><div><p className="text-xs text-[#7D7188]">Role</p><p className="font-bold text-[#281546]">Branch Manager</p></div></div>
                            </div>
                        </div>
                    </div>
